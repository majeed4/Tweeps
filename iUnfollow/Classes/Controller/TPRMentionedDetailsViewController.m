//
//  TPRMentionedDetailsViewController.m
//  Tweepr
//
...
@interface TPRMentionedDetailsViewController ()
...
@implementation TPRMentionedDetailsViewController
...
- (void)reloadView
{
    self.tweets = [self.user.mentionedInTweets.allObjects sortedArrayUsingComparator:^NSComparisonResult(UserTweet *t1, UserTweet *t2) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    l.text = [NSString stringWithFormat:@"%@ @%@", NSLocalizedString(@"Tweets mentioning", nil), self.user.screenName];
         ...
         cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.hasMedia = NO;
    __weak TPRTweetTableCell *wcell = cell;
