...
#import "TPRRetweeterProfileViewController.h"
#import "TPRUsersTableCell.h"

@interface TPRRetweetersViewController ()

@end

@implementation TPRRetweetersViewController
...
- (void)viewDidLoad
{
    ...
    [super viewDidLoad];
    self.title = NSLocalizedString(@"Retweeters", nil);
}
...
- (void)updateDataSource
{
    ...
    self.items = [[DataManager sharedInstance] getAllRetweeters];
    self.items = [self.items sortedArrayUsingDescriptors:@[[NSSortDescriptor sortDescriptorWithKey:@"retweets.@count" ascending:NO]]];
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TPRRetweeterProfileViewController *vc = [[TPRRetweeterProfileViewController alloc] initWithUser:user];
