//
//  TPRMentioningDetailsViewController.m
//  Tweepr
//
...
@interface TPRMentioningDetailsViewController ()
...
@implementation TPRMentioningDetailsViewController
...
- (void)reloadView
{
    self.tweets = [self.user.tweetsMentioningUser.allObjects sortedArrayUsingComparator:^NSComparisonResult(Tweet *t1, Tweet *t2) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    l.text = NSLocalizedString(@"Tweets mentioning you", nil);
