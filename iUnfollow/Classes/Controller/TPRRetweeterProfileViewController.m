//
//  TPRRetweeterProfileViewController.m
//  Tweepr
//
...
@interface TPRRetweeterProfileViewController ()
...
@implementation TPRRetweeterProfileViewController
...
- (void)reloadView
{
    self.tweets = [self.user.retweets.allObjects sortedArrayUsingComparator:^NSComparisonResult(Tweet *t1, Tweet *t2) {
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    l.text = NSLocalizedString(@"Tweets retweeted for you", nil);
